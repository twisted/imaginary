...
from reality.container import IOpenTarget, ICloseTarget
...
class Door(thing.Thing):
    ...
    __implements__ = (IOpenTarget, ICloseTarget, thing.Thing.__implements__)
    ...
    def toolOpen(self, actor=None):
        raise DispatchKeepGoing
    def toolClose(self,actor=None):
        raise DispatchKeepGoing
