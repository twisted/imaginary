...
#
# Written by Greg Stein (gstein@svpal.org)
#		  and Bill Tutt (rassilon@canned.recycled.net)
# February 1997.
#
#
...
class Transformer:
  ...
  def for_stmt(self, nodelist):
    ...
    return Node('for', assignNode, listNode, bodyNode, elseNode, nodelist[0][2])
  ...
  def com_node(self, node):
    ...
    #		and compound_stmt.	We'll just dispatch them.
