"""
Your trusty old Ford Runabout
"""


from Reality.thing import Thing
from twisted.python.observable import Dynamic
...
class Describer(Dynamic):
    ...
    def __repr__(self): # I AM CHEATING HERE
        return "Inheritance.car.Describer(t(%s))"%repr(self.car.name)
