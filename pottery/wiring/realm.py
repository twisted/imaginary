...
from pottery import objects, epottery
...
class PotteryRealm(item.Item, item.InstallableMixin):
    ...
    def __init__(self, **kw):
        super(PotteryRealm, self).__init__(**kw)
    ...
    def installOn(self, other):
        super(PotteryRealm, self).installOn(other)
    ...
    def create(self, username, password):
        ...
        ipottery.IContainer(self.origin).add(playerObj)
        return playerObj
